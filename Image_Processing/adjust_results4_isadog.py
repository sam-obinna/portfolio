...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        value1 = results_dic[key][0]
        value2 = results_dic[key][1]

        if value1 in dognames_dic:
            results_dic[key].extend([1]) 
        else:
            results_dic[key].extend([0]) 
        
    
        if value2 in dognames_dic:
            results_dic[key].extend([1]) 
...
# classify_images(in_args.dir,results_dic,in_args.arch)
