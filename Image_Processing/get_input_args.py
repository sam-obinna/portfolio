...
def get_input_args():
    ...
    parser.add_argument('--dogfile', type = str, default = 'dognames.txt', help = 'A file containing dog images')
    parser.add_argument('--arch', type = str, default = 'vgg', help = 'The CNN Architecture to be used')
